  ...
  return (
    <SafeAreaView style={S.pantalla}>
      <KeyboardAvoidingView
        ...
        style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={[S.contenido, { flexGrow: 1, justifyContent: 'center' }]}>
      ...
      <ScrollView contentContainerStyle={S.contenido}>
        ...
        <Card>
          <Text style={S.texto}>
            ...
            competiciones y resultados. Crea el proyecto, ejecuta las
            migraciones de <Text style={{ fontWeight: '700' }}>supabase/migrations</Text> y
            copia las claves en un fichero <Text style={{ fontWeight: '700' }}>.env.local</Text>:
          </Text>
          <Text style={[S.textoSuave, { marginTop: 12, fontFamily: 'Barlow_400Regular' }]}>
